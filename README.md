...
New to the project? Start with [docs/00-quickstart.md](docs/00-quickstart.md) (English, one-page). A more detailed step-by-step deployment walkthrough in Vietnamese lives at [thingsboard/import.md](thingsboard/import.md).
