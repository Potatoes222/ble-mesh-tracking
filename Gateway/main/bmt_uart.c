...
static void uart_cmd_task(void *arg)
{
    ...
    while (1) {
        ...
        switch (ch) {
        case '1': bmt_node_table_print();  break;
        case '2': bmt_zone_log_tracked();  break;
        case '3': bmt_mqtt_log_stats();    break;
